...
function ModalA() {
  ...
  useEffect(() => {
    ...
    const apiUrl = `https://contact.mediusware.com/api/contacts/?page=${pageNumber}`; // Replace with your API URL
  ...
  const handleScroll = () => {
    ...
    if (scrollContainer) {
      ...
      const threshold = 500; // Adjust the threshold as needed
      const newPageNumber = Math.floor(scrollTop / threshold) + 1;
      ...
      <div className={`modal${show ? ' show' : ''} `} tabIndex="-1" role="dialog" style={{ display: show ? 'block' : 'none' }}>
        <div className="modal-dialog modal-dialog-centered" role="document">
          <div className="modal-content">
            ...
            <div className="modal-body" style={{ height: '300px', overflowY: 'auto' }} ref={scrollContainerRef} onScroll={handleScroll}>
